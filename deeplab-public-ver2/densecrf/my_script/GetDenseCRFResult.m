...
addpath('/home/king/Documents/deeplab_v2/deeplab-public-ver2/densecrf/my_script');
SetupEnv;
...
if is_server
  if learn_crf
    ...
    map_folder = fullfile('/home/king/Documents/deeplab_v2/exper', dataset, 'densecrf', 'res', feature_name, model_name, testset, feature_type, post_folder); 
    ...
    map_folder = fullfile('/home/king/Documents/deeplab_v2/exper', dataset, 'res', feature_name, model_name, testset, feature_type, post_folder); 
...
elseif strcmp(dataset, 'rgbd')
  seg_res_dir = [save_root_folder, '/results/rgbd/'];
else
  error('Wrong dataset!');
end
fprintf(1,'save_result_folder: %s\n', seg_res_dir);
