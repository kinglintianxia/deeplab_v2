...
#######################################
SAVE_DIR=/home/king/Documents/deeplab_v2/exper/${DATASET}/res/${FEATURE_NAME}/${MODEL_NAME}/${TEST_SET}/${FEATURE_TYPE}/post_densecrf_W${Bi_W}_XStd${Bi_X_STD}_RStd${Bi_R_STD}_PosW${POS_W}_PosXStd${POS_X_STD}

echo "SAVE TO ${SAVE_DIR}"

CRF_DIR=/home/king/Documents/deeplab_v2/deeplab-public-ver2/densecrf

#if [ ${DATASET} == "voc2012" ]
#then
    IMG_DIR_NAME=meetting
#elif [ ${DATASET} == "coco" ]
#then
 #   IMG_DIR_NAME=coco
...
IMG_DIR=/home/king/Documents/image/${IMG_DIR_NAME}/PPMImages

if [ ${LOAD_MAT_FILE} == 1 ]
then
    # the features are saved in .mat format
    CRF_BIN=${CRF_DIR}/prog_refine_pascal_v4
    FEATURE_DIR=/home/king/Documents/deeplab_v2/exper/${DATASET}/${FEATURE_NAME}/${MODEL_NAME}/${TEST_SET}/${FEATURE_TYPE}
else
